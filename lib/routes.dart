...
final List<GetPage> appRoutes = [
  ...
  GetPage(
    name: '/products',
    page: () => const Product_listView(),
    binding: BindingsBuilder(() => Get.put(Product_listController())),
  ),
  GetPage(
    name: '/product_details',
    page: () => const Product_detailsView(),
    binding: BindingsBuilder(() => Get.put(Product_detailsController())),
  ),
  GetPage(
    name: '/cart',
    page: () => const CartView(),
    binding: BindingsBuilder(() => Get.put(CartController())),
  ),
  GetPage(
    name: '/settings',
    page: () => const SettingsView(),
    binding: BindingsBuilder(() => Get.put(SettingsController())),
  ),
  GetPage(
    name: '/orders',
    page: () => const OrdersView(),
    binding: BindingsBuilder(() => Get.put(OrdersController())),
  ),
  GetPage(
    name: '/invoice',
    page: () => const InvoiceView(),
    binding: BindingsBuilder(() => Get.put(InvoiceController())),
  ),
  GetPage(
    name: '/order_status',
    page: () => const Order_statusView(),
    binding: BindingsBuilder(() => Get.put(Order_statusController())),
  ),
  GetPage(
    name: '/mode',
    page: () => const ModeView(),
    binding: BindingsBuilder(() => Get.put(ModeController())),
  ),
];
